...
export const ligeia = {
  ...
  exploration: {
    ...
    {
      name: 'タランチュラ',
      desc: '女王の騎士のようにタランチュラに守らせる。ライジーアがマイナス効果を受ける度、タランチュラが1匹犠牲となって無効化する。さらにライジーアの攻撃力が8/12/16/20/24%上昇、10秒間持続。タランチュラは10秒毎に1匹生成され、最大3匹まで存在',
  ...
  expedition: {
    ...
    {
      name: 'スチールファング',
      desc: '蜘蛛の群れを解き放ち、鋼鉄の牙で敵の甲冑を破壊する。敵全体の防御力を5/10/15/20/25%低下させる',
      icon: '/images/skills/hero_skill_icon_500494.png',
    },
    {
      name: '崩壊の毒',
      desc: '部隊の射撃中に機械蜘蛛を敵の間に送り込む。弓兵が2回攻撃する毎に対象に20/40/60/80/100%の追加ダメージを与える。さらに蜘蛛の酸液で敵の甲冑を溶かし、対象の被ダメージを5/10/15/20/25%上昇させる。1ターン持続',
      icon: '/images/skills/hero_skill_icon_500495.png',
    },
    {
      name: 'ポイズンファング',
      desc: '蜘蛛の毒液を矢や石弾に塗り付ける。弓兵が2回攻撃する毎に対象を毒状態にし、20/40/60/80/100%の追加ダメージを与える。さらに対象の与ダメージを4/8/12/16/20%減少させる。1ターン持続',
  ...
  specialEquipment: {
    ...
    {
      name: 'スパイダー・クイーン',
      desc: '蜘蛛の巣を編んで群れを操る、卓越した戦闘術。戦闘開始毎にタランチュラを2匹自動召喚し、フェイトウェブが100%の確率で1体の追加ターゲットに命中する',
      icon: '/images/skills/hero_skill_icon_500497.png',
    },
    {
      name: 'ネストキャッスル',
      desc: 'ライジーアの戦術により、城壁は獲物を捕らえる巨大な網となる。防衛部隊の攻撃力が15%上昇',
