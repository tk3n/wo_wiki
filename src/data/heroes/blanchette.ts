...
export const blanchette = {
  ...
  exploration: {
    ...
    {
      name: '緋紅の一閃',
      desc: '攻撃力200/220/240/260/280%のダメージを与える。さらに5秒治療不可状態にする。',
    ...
    {
      name: '猩紅の追跡',
      desc: 'ターゲットのHP値が低いほど、ブランシュの通常攻撃のダメージが高くなる。最大10/20/30/40/50%上昇する。',
  ...
  expedition: {
    ...
    {
      name: '黒紅の狙撃',
      desc: '弓兵は2回攻撃する毎に敵槍兵に8/16/24/32/40%、敵弓兵に 4/8/12/16/20% の追加ダメージを与える。',
  ...
  specialEquipment: {
    ...
    {
      name: '赤紅の狂熱',
      desc: '攻撃速度が10/15/20/25/30%上昇する。さらに緋紅の一閃による治療禁止効果が5秒延長する。',
