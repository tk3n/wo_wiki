...
export const gwen = {
  ...
  expedition: {
    ...
    {
      name: 'ホークアイ',
      desc: '味方全部隊の攻撃時、ターゲットの被ダメージが 5%/10%/15%/20%/25%上昇する。',
      icon: '/images/skills/hero_skill_icon_500264.png',
    },
    {
      name: '空中制圧',
      desc: '味方全部隊が5回攻撃する度、ターゲットに20%/40%/60%/80%/100%の追加ダメージを与え、次回ターゲットに攻撃された際に5%/7.5%/10%/12.5%/15%の追加ダメージを与える。',
  ...
  specialEquipment: {
    ...
    {
      name: '協力攻撃',
      desc: 'スキル発動時に毎回、ランダムなターゲットにグエンの攻撃力50%/55%/60%/65%/70%のダメージを与える（英雄優先）。',
