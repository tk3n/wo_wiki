...
export const rufus = {
  ...
  exploration: {
    ...
    {
      name: '爆怒の暴狂',
      desc: '戦場のルーファスは燃え盛る炎のように誰も止められない。会心率が7/10/13/16/20%上昇。',
  ...
  expedition: {
    ...
    {
      name: '火焔戦団',
      desc: 'ルーファスの大胆不敵な指揮により、味方全部隊が戦場を巡る炎となる。攻撃力が5/10/15/20/25%上昇する。',
      icon: '/images/skills/hero_skill_icon_500464.png',
    },
    {
      name: '砕鎧の一撃',
      desc: 'ルーファスは部下の弓兵に徹甲弾を装備させる。攻撃する度にターゲットに12/24/36/48/50%の追加ダメージを与え、さらに被ダメージを5/10/15/20/25%上昇させる。1ターン持続。',
      icon: '/images/skills/hero_skill_icon_500465.png',
    },
    {
      name: '苛烈震撼',
      desc: 'ルーファスは猛攻戦法で敵を圧倒する。味方全部隊の攻撃時に、20%の確率で敵の殺傷力を10/20/30/40/50%低下させる。2ターン持続。',
  ...
  specialEquipment: {
    ...
    {
      name: '烈火旅団',
      desc: 'ルーファスの不死鳥の旗の下、集結部隊が戦場で不滅の炎となる。攻撃力が5/7.5/10/12.5/15%上昇する。',
