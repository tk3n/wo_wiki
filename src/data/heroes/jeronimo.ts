...
export const jeronimo = {
  ...
  exploration: {
    ...
    {
      name: '孤高',
      desc: 'HPが50%以上の時、攻撃力が16%/24%/32%/40%/48%上昇する。',
  ...
  expedition: {
    ...
    {
      name: '決起集会',
      desc: '味方全部隊の与ダメージを5%/10%/15%/20%/25%上昇させる。',
      icon: '/images/skills/hero_skill_icon_500114.png',
    },
    {
      name: '剣術指導',
      desc: '味方全部隊の攻撃力を5%/10%/15%/20%/25%上昇させる。',
      icon: '/images/skills/hero_skill_icon_500115.png',
    },
    {
      name: '練達なる剣技',
      desc: '4ターン毎に味方全部隊の与ダメージが6%/12%/18%/24%/30%上昇する。2ターン持続。',
  ...
  special: [
    {
      name: '天性のリーダー',
      desc: 'ジェロニモが出征するしないに関わらず、出征中の英雄が率いる部隊殺傷力とHPが3%/6%/9%/12%/15%増加します。',
    },
  ],
  specialEquipment: {
    name: '暁の刃(Lv.10)',
    ...
    {
      name: '剣盾',
      desc: '攻撃時に、自身の被ダメージを10%/15%/20%/25%/30%低下させる。',
      icon: '/images/skills/hero_skill_icon_500117.png',
    },
    {
      name: '真実の術',
      desc: '集結部隊の攻撃力を 5%/7.5%/10%/12.5%/15%上昇させる。',
