...
export const bahiti = {
  ...
  exploration: {
    ...
    {
      name: 'クイックショット',
      desc: '豊富な氷原サバイバル経験により、攻撃速度が10%/15%/20%/25%/30%上昇する。',
      icon: '/images/skills/hero_skill_icon_500062.png',
    },
    {
      name: 'シャープスコープ',
      desc: 'バシティは銃を使いこなす。与ダメージが 10%/15%/20%/25%/30%上昇する。',
  ...
  expedition: {
    ...
    {
      name: '危険予知',
      desc: 'バシティは危険を予知して対策を講じ、味方全部隊の被ダメージが4%/8%/12%/16%/20%減少する。',
      icon: '/images/skills/hero_skill_icon_500064.png',
    },
    {
      name: '運否天賦',
      desc: 'バシティが戦況をよく把握するため、味方全部隊が攻撃時、50%の確率でダメージが10%/20%/30%/40%/50%上昇する。',
