...
export const logan = {
  ...
  exploration: {
    ...
    {
      name: '滅塵拳',
      desc: '前方のターゲットに攻撃力120%/132%/144%/156%/168%のダメージを与え、攻撃速度を50%低下させる。4秒持続',
      icon: '/images/skills/hero_skill_icon_500101.png',
    },
    {
      name: 'パワーアーマー',
      desc: '攻撃を受けた際8%/10%/12%/14%/16%の確率で防御力が8%/11%/13%/17%/20%上昇する。2秒持続、最大5回まで重複可能。',
      icon: '/images/skills/hero_skill_icon_500102.png',
    },
    {
      name: '怒りの猛撃',
      desc: '扇形範囲内のターゲットに攻撃力80%/88%/96%/104%/112%のダメージを与え、30%の確率でターゲットを眩暈状態にする。1秒持続。',
  ...
  expedition: {
    ...
    {
      name: '猛き獅子の威嚇',
      desc: '味方全部隊の被ダメージが4%/8%/12%/16%/20%低下する。',
  ...
  specialEquipment: {
    ...
    {
      name: '鉄拳強化',
      desc: '自身の与ダメージが10%/15%/20%/25%/30%上昇',
      icon: '/images/skills/hero_skill_icon_500107.png',
    },
    {
      name: '鉄腕の守り',
      desc: '防衛部隊防御力が5%/7.5%/10%/12.5%/15%上昇する。',
