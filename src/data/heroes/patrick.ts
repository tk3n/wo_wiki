...
export const patrick = {
  ...
  exploration: {
    ...
    {
      name: 'バーベキュー',
      desc: '味方全体のHPをパトリックの攻撃力200%/220%/240%/260%/280%分回復する。さらに味方全体の攻撃力が5%/5.5%/6%/6.5%/7%上昇する。4秒持続。',
      icon: '/images/skills/hero_skill_icon_500051.png',
    },
    {
      name: '肉厚脂肪',
      desc: '自身の被ダメージが10%/15%/20%/25%/30%低下する。',
      icon: '/images/skills/hero_skill_icon_500052.png',
    },
    {
      name: '非常食',
      desc: '5秒毎に攻撃50%/55%/60%/65%/70%分のHPを回復する。',
