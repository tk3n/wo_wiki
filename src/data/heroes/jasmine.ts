...
export const jasmine = {
  ...
  exploration: {
    ...
    {
      name: '不意打ち',
      desc: '雪上に隠れて奇襲を仕掛け、ターゲットに攻撃150%/165%/180%/195%/210%のダメージを与える。',
      icon: '/images/skills/hero_skill_icon_500122.png',
    },
    {
      name: '少女の執念',
      desc: '逆境により、ジャスミンの底知れぬ潜在能力が発揮される。HPが50%以下の時、攻撃速度が20%/30%/40%/50%/60%上昇する。',
  ...
  expedition: {
    ...
    {
      name: '雪霧の庇護',
      desc: '吹き荒れる雪霧が敵の視界を遮る。40%の確率で味方全部隊の被ダメージを10%/20%/30%/40%/50%軽減する。',
      icon: '/images/skills/hero_skill_icon_500124.png',
    },
    {
      name: '氷結の領域',
      desc: '雪上はジャスミンの主戦場に他ならない。味方全部隊の攻撃時、50%の確率で今回の攻撃によるダメージが10%/20%/30%/40%/50%上昇する。',
      icon: '/images/skills/hero_skill_icon_500125.png',
    },
    {
      name: '不機嫌少女',
      desc: 'ジャスミンの怒りは全員の戦意を鼓舞する。味方全部隊の与ダメージが5%/10%/15%/20%/25%上昇する。',
