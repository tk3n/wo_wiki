...
export const wayne = {
  ...
  expedition: {
    ...
    {
      name: 'サンダーサプライズ',
      desc: 'ウェインが立案した緻密な奇襲作戦により、味方全部隊が4ターン毎に1度追加攻撃を行い、20%/40%/60%/80%/100%のダメージを与える。',
      icon: '/images/skills/hero_skill_icon_500314.png',
    },
    {
      name: '迂回攻撃',
      desc: 'ウェインは防衛線を迂回して敵の弱点を突く戦術を得意とする。弓兵が2回攻撃する毎に、敵槍兵に8%/16%/24%/32%/40%、敵弓兵に4%/8%/12%/16%/20%の追加ダメージを与える。',
      icon: '/images/skills/hero_skill_icon_500315.png',
    },
    {
      name: '電光石火',
      desc: '鋭い洞察力により、ウェインは敵の弱点を1つたりとも見逃さない。味方全部隊の通常攻撃で5%/10%/15%/20%/25%の確率で会心を発生させる。',
  ...
  specialEquipment: {
    ...
    {
      name: '先手必勝',
      desc: 'ウェインは防衛施設を利用した先制攻撃を熟知している。その戦術の効果により、防衛部隊の殺傷力が5%/7.5%/10%/12.5%/15%上昇する。',
