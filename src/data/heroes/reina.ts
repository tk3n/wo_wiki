...
export const reina = {
  ...
  expedition: {
    ...
    {
      name: '暗殺者の本能',
      desc: '味方全部隊の通常攻撃の与ダメージを10%/15%/20%/25%/30%上昇させる。',
      icon: '/images/skills/hero_skill_icon_500144.png',
    },
    {
      name: '残像の足跡',
      desc: '味方全部隊が通常攻撃を受けた際、4%/8%/12%/16%/20%の確率でダメージを回避する。',
      icon: '/images/skills/hero_skill_icon_500145.png',
    },
    {
      name: '影刃',
      desc: '槍兵が25%の確率で1回追加攻撃を行い、120%/140%/160%/180%/200%のダメージを与える。',
  ...
  specialEquipment: {
    ...
    {
      name: '炎の如き略奪',
      desc: '集結部隊の殺傷力5%/7.5%/10%/12.5%/15%を上昇させる。',
