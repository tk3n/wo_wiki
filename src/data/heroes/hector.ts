...
export const hector = {
  ...
  expedition: {
    ...
    {
      name: '雷の突撃',
      desc: 'ヘクトーは奇襲で敵陣を崩して引で一掃する戦法を得意とする。盾兵の与ダメージが100%/125%/150%/175%/200%、弓兵の与ダメージが20%/40%/60%/80%/100%上昇。攻撃の度に強化効果が前回の85%になり、10回攻撃する間有効。',
  ...
  specialEquipment: {
    ...
    {
      name: '血の舞',
      desc: '剣先の火花が戦意に火をつけ、鋼刃戦舞の持続時間を1.5秒延長する。その間、自身のHPを与ダメージの7%/9%/11%/13%/15%回復。',
      icon: '/images/skills/hero_skill_icon_500247.png',
    },
    {
      name: '難攻不落 (lvl5)',
      desc: 'ヘクトーが有利な地形を最大限利用して侵入者を殺傷し、防衛部隊の攻撃力が5%/7.5%/10%/12.5%/15%上昇する。',
