...
export const greg = {
  ...
  exploration: {
    ...
    {
      name: '公正判決',
      desc: '敵の被ダメージを10%/15%/20%/25%/30%上昇させる。3秒持続。',
  ...
  expedition: {
    ...
    {
      name: '正義の剣',
      desc: '20%の確率で味方全部隊のダメージが8%/16%/24%/32%/40%上昇する。3ターン持続。',
      icon: '/images/skills/hero_skill_icon_500204.png',
    },
    {
      name: '律令の脅威',
      desc: '味方全部隊の攻撃時、20%の確率で敵軍のダメージを10%/20%/30%/40%/50%低下させる。2ターン持続。',
  ...
  specialEquipment: {
    ...
    {
      name: '正義のラッパ',
      desc: '集結部隊のHPが5%/7.5%/10%/12.5%/15%上昇する。',
