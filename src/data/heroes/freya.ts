...
export const freya = {
  ...
  exploration: {
    ...
    {
      name: '血焰の怒り(Lv.5)',
      desc: '8/7/6/5/4回通常攻撃する度に、次の通常攻撃の会心率が60/70/80/90/100%上昇する。',
  ...
  expedition: {
    ...
    {
      name: '新月の鎌(Lv.5)',
      desc: '通常攻撃後に50%の確率で追撃が1度発動し、20/40/60/80/100%の追加ダメージを与える。',
      icon: '/images/skills/%E5%AE%88%E5%A4%9C%E4%BA%BA6.png',
    },
    {
      name: '疾風の一撃(Lv.5)',
      desc: '味方の盾兵と弓兵の被ダメージが3/6/9/12/15%低下し、与ダメージが3/6/9/12/15%上昇する。',
  ...
  specialEquipment: {
    ...
    {
      name: '闇夜の襲撃(Lv.5)',
      desc: 'フレイヤの与ダメージが10/15/20/25/30%上昇する。また、敵がユニットを召喚した際、そのユニットに対して攻撃力*100/150/200/250/300%のダメージを与える。',
