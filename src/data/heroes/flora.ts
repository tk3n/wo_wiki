...
export const flora = {
  ...
  exploration: {
    ...
    {
      name: '自然の力(Lv.5)',
      desc: '丹念な栽培により植物は驚異的な耐久力を得た。そして育てた本人もまた、試練の中で同じく強靭な資質を身につけた。フローラと彼女の召喚した植物のHPが 2%/4%/6%/8%/10%、防御力が4%/8%/12%/16%/20%上昇する',
  ...
  expedition: {
    ...
    {
      name: '刺蔓の舞(Lv.5)',
      desc: '鋭い棘を持つ藤蔓を召喚し、戦士達と共に舞う。味方全体の攻撃時に敵が受けるダメージを50%の確率で10%/20%/30%/40%/50%上昇させる',
      icon: '/images/skills/hero_skill_icon_500514.png',
    },
    {
      name: '茨の花園(Lv.5)',
      desc: '強靭な根茎で防衛線を築き、味方盾兵の被ダメージを 5%/10%/15%/20%/25%軽減する。また、エイドリアローズの毒針が味方槍兵と連携し、槍兵の与ダメージが5%/10%/15%/20%/25%上昇する',
      icon: '/images/skills/hero_skill_icon_500515.png',
    },
    {
      name: '芳香の霧(Lv.5)',
      desc: '敵の士気を惑わす奇妙な花の香りで撹乱する。4ターン毎に発動し、敵の盾兵の被ダメージを6%/12%/18%/24%/30%, 上昇させ、敵の弓兵の与ダメージを6%/12%/18%/24%/30%低下させる。2ターン持続',
  ...
  specialEquipment: {
    ...
    {
      name: '自然の祝福(Lv. 5)',
      desc: 'フローラが育てた神秘的な果実は、防衛部隊に信じられないほどの力を与える。防衛部隊のHPが5/7.5/10/12.5/15%増加する',
