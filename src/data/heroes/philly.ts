...
export const philly = {
  ...
  exploration: {
    ...
    {
      name: '応急手当',
      desc: '自軍のすべての英雄のHPが彼女の攻撃力200/220%/240%/260%/280%分回復する。',
      icon: '/images/skills/hero_skill_icon_500131.png',
    },
    {
      name: 'ゴッドハンド',
      desc: '自軍でHPのパーセンテージが最も低い英雄を攻撃力100%/110%/120%/130%/140%分回復させる。',
      icon: '/images/skills/hero_skill_icon_500132.png',
    },
    {
      name: '麻痺毒素',
      desc: '敵単体を毒状態にし、攻撃140%/154%/168%/182%/196%のダメージを与える。さらに1秒間行動不能にする。',
  ...
  expedition: {
    ...
    {
      name: '強化薬剤',
      desc: '味方全部隊が攻撃する際、25%の確率で120%/140%/160%/180%/200%のダメージを与える。',
  ...
  specialEquipment: {
    ...
    {
      name: 'エキス抽出',
      desc: 'HPを回復するスキルの効果が30%/40%/50%/60%/70%上昇する。',
      icon: '/images/skills/hero_skill_icon_500137.png',
    },
    {
      name: '救急訓練',
      desc: '防衛部隊のHPが5%/7.5%/10%/12.5%/15%上昇した',
