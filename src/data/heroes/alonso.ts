...
export const alonso = {
  ...
  exploration: {
    ...
    {
      name: '銛強打',
      desc: '8/7/7/6/5回の通常攻撃毎に次回の攻撃でターゲットを眩暈状態にする。0.2/0.2/0.4/0.4/0.5秒持続。',
  ...
  expedition: {
    ...
    {
      name: '鋼鉄意志',
      desc: '味方全部隊が攻撃する際、20%の確率で敵のダメージが10%/20%/30%/40%/50%減少する。2ターン持続。',
      icon: '/images/skills/hero_skill_icon_500185.png',
    },
    {
      name: '毒の銛',
      desc: '味方全部隊が攻撃する際、50%の確率で今回の攻撃によるダメージが10%/20%/30%/40%/50%上昇する。',
  ...
  specialEquipment: {
    ...
    {
      name: '深海の饗宴',
      desc: '通常攻撃の度に美味しそうな魚が、自軍のHPが最も低い英雄をアロンゾの攻撃力5%/7.5%/10%/12.5%/15%分回復させる。',
      icon: '/images/skills/hero_skill_icon_500187.png',
    },
    {
      name: '銛強化',
      desc: '集結部隊の与ダメージを5%/7.5%/10%/12.5%/15%上昇させる。',
