...
export const rum_borgan = {
  ...
  exploration: {
    ...
    {
      name: '群山咆哮',
      desc: '敵全体の攻撃力を1%/2%/3%/4%/5%低下させる。2秒持続。',
      icon: '/images/skills/hero_skill_icon_500291.png',
    },
    {
      name: '戦吼鼓舞',
      desc: '「群山咆哮」を発動すると、自身と自身周辺の味方の攻撃力が15%/20%/25%/30%/35%上昇する。2秒持続。',
  ...
  expedition: {
    ...
    {
      name: '誘惑戦術',
      desc: '敵全体の与ダメージを4%/8%/12%/16%/20%低下させる',
      icon: '/images/skills/hero_skill_icon_500294.png',
    },
    {
      name: 'エメラルドの勇者',
      desc: '獣討伐部隊の出征速度が20%/40%/60%/80%/100%上昇する',
