...
export const xura = {
  ...
  expedition: {
    ...
    {
      name: '霧の胞子',
      desc: '味方全部隊の被ダメージを4/8/12/16/20%低下させる。',
      icon: '/images/skills/hero_skill_icon_500404.png',
    },
    {
      name: '貫通の矢',
      desc: '弓兵が2回攻撃する度にターゲットに20/40/60/80/100%の追加ダメージを与え、被ダメージを5/10/15/20/25%上昇させる。1ターン持続。',
      icon: '/images/skills/hero_skill_icon_500405.png',
    },
    {
      name: '変幻自在',
      desc: '弓兵の被ダメージが3/6/9/12/15%低下し、与ダメージが2/4/6/8/10%上昇する。',
