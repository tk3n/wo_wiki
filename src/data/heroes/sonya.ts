...
export const sonya = {
  ...
  exploration: {
    ...
    {
      name: '金の亡者',
      desc: '報酬への渇望がソニヤを刺激する。攻撃速度が10%/15%/20%/25%/30%上昇する。',
  ...
  expedition: {
    ...
    {
      name: 'トレジャーハンター',
      desc: '「伝説の深海のお宝を発見したら、全員に分け前を与えるよ！」ソ二ヤの約束は全員の士気と高める。味方全部隊の与ダメージが4%/8%/12%/16%/20%上昇する。',
      icon: '/images/skills/hero_skill_icon_500354.png',
    },
    {
      name: '賞金の誘惑',
      desc: 'ソニヤは賞金で兵士を激励する。率いる槍兵が2回攻撃する度にターゲットに15%/30%/45%/60%/75%の追加ダメージを与える。さらに、味方全部隊の攻撃力が5%/10%/15%/20%/25%上昇する。1ターン持続。',
      icon: '/images/skills/hero_skill_icon_500355.png',
    },
    {
      name: '激流衝撃',
      desc: 'ソニヤの槍兵はすべてのチャンスを物にし、海底の激流のような突撃を行う。槍兵は5ターン毎にターゲットに50%/100%/150%/200%/250%のダメージを与え、1ターン眩暈状態にする。',
  ...
  specialEquipment: {
    ...
    {
      name: '骨の髄まで凍る',
      desc: 'ソニヤは冷凍液の配合を改良する。自身の攻撃力が8%/12%/16%/20%/24%上昇する。さらに、極度厳寒の凍結効果が終了した際、周囲に攻撃力50%/55%/60%/65%/70%の砕氷ダメージを与える。',
